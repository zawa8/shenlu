...
// Image metadata
export const alt = "vimAl_kumar blog";
      ...
      <div tw="flex flex-col bg-white w-full h-full justify-between p-12">
        <div tw="flex flex-col">
          <div tw="flex justify-center">
            <img width="200" height="200" tw="bg-white rounded-full"
              src={`${
          ...
          <div
            ...
            style={{ lineHeight: "80px" }}
          >
            A coder codiNg for typescript reAct nextjs tAilwindcss projects.
          </div>
        </div>
        <div tw="flex justify-between">
          <div tw="flex items-center">
            <div tw="flex flex-col">
              <span tw="flex text-3xl font-extrabold mb-2">vimAl_kumar's blog</span>
